...
import { courseTabs, landingCourses } from "@/data/landing";
    ...
    <section id="courses" className="bg-[#FAFAFA] px-5 py-[88px] sm:px-8 lg:px-[100px]">
      <div className="mx-auto max-w-[1240px]">
        <SectionHeader
          ...
          description="Find the best course for your preferences and boosts your carreer 10x!"
        />

        <div className="mt-10 flex overflow-x-auto border-b border-[#C6CAD1] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
